...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_I2_S          = 41, // except 1d tensors (BitNet I2_S; MS fork used 40 before Q1_0)
    ...
    struct llama_context_params {
        ...
        bool kv_vram_only; // force KV cache to VRAM even if weights are on host RAM (e.g. -ngl 0)
