...
| `--log-payloads` | Log server request payloads (raw body + parsed/after-conversion JSON) at SRV_INF level with timestamps when enabled (default: disabled)<br/>(env: LLAMA_ARG_LOG_PAYLOADS) |
