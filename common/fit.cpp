...
static std::vector<llama_device_memory_data> common_get_device_memory_data_impl(
    ...
    // Count NextN/MTP blocks so --fit does not leave layer 0 on CPU (disables
    // fused GDN). Port of ggml-org/llama.cpp#26177 (b10152+); re-applied after
    // BeeLlama upstream/main merge 2026-07-28.
